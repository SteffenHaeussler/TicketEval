...
AGENT_BACKEND = os.environ.get("TICKETFLOW_AGENT_BACKEND", "mock")
OLLAMA_ENDPOINT = os.environ.get("TICKETFLOW_OLLAMA_ENDPOINT", "http://localhost:11434")
PRIMARY_MODEL = os.environ.get("TICKETFLOW_PRIMARY_MODEL", "qwen3.6:35b")
FALLBACK_MODEL = os.environ.get("TICKETFLOW_FALLBACK_MODEL", "qwen2.5-coder:1.5b")
OLLAMA_TIMEOUT_S = float(os.environ.get("TICKETFLOW_OLLAMA_TIMEOUT_S", "90"))
OLLAMA_SEED = int(os.environ.get("TICKETFLOW_OLLAMA_SEED", "0"))
